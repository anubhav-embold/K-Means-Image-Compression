...
class plot_utils:
    # using a subset of 10,000 pixels (for efficiency reasons), we visualize & plot the color space
    # using default arguments for 'num_pixels' & 'colors'
    ...
    def colorSpace(self):
        ...
        # 1,2 represents 1 row 2 columns
        # plotting two scatter plots of 10,000 random pixels
